  ...
  return createPortal(
    <>
      ...
      <ConfirmModal
        ...
        message={`Are you sure you want to permanently delete "${cardToDelete?.title}"? All checklists, attachments, and comments will be destroyed. This cannot be undone.`}
